...
<body>
    <nav class="p-2 shadow-md fixed w-full md:p-5 md:py-0 md:flex md:items-center md:justify-between">
        ...
        <ul class="text-xs text-center font-bold mt-0 mr-4 right-7 grid gap-y-4 z-[40] absolute rounded-3xl p-5 opacity-0 top-[-400px] transition-all ease-in duration-500 md:text-lg md:flex md:mt-0 md:items-center md:flex-row md:gap-x-10 md:z-auto md:static md:w-auto md:opacity-100">
            <li><a href="/Appdev/index.php" class="hover:text-[#B8764B] text-white md:text-white duration-500 md:hover:text-[#B8764B] button">Home</a></li>
            <li><a href="about.php" class="hover:text-[#B8764B] text-white md:text-white duration-500 md:hover:text-[#B8764B] button">About us</a></li> 
            <li><a href="contact.php" class="hover:text-[#B8764B] text-white md:text-white duration-500 md:hover:text-[#B8764B] button">Contact us</a></li>
            <button class="shadow-[#B8764B] p-2 rounded-2xl hover:scale-125 duration-300 text-[#B8764B] hover:text-[#DAC5B7]"><a href="./components/login.php">Login</a></button>
        </ul>
    </nav>
